...
class APIShiftIOTest < Minitest::Test
  ...
  def test_shift_write
    ...
    mock.expect :call, nil, [Dino::Message.encode(command: 21, pin: 3, value: 3, aux_message: settings1 + bytes1)]
    mock.expect :call, nil, [Dino::Message.encode(command: 21, pin: 3, value: 1, aux_message: settings2 + bytes2)]
  ...
  def test_shift_read
    ...
    mock.expect :call, nil, [Dino::Message.encode(command: 22, pin: 3, value: 4, aux_message: settings3)]
  ...
  def test_shift_listen
    ...
    mock = MiniTest::Mock.new
    mock.expect :call, nil, [Dino::Message.encode(command: 23, pin: 3, value: 4, aux_message: settings)]
